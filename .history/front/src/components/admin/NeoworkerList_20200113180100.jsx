...
const NeoworkerList = () => {
    ...
    const [neoworkerAvailable, setNeoworkerAvailable] = usestate([])
    const [neoworkerPartTime, setNeoworkerPartTime] = useState([])
    const [neoworkerNotAvailable, setNeoworkerNotAvailable] = useState([])
