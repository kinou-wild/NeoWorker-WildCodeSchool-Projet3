            ...
            <form className="formulaire-creation-neoworker" onSubmit={queryData} >
                ...
                <div className="third-div-creation-neoworker">
                    ...
                    <div className="div-pref_lieu_travail">
                        ...
                        <select className="input-pref_lieu_travail" type="text" id="pref_lieu_de_travail" name="pref_lieu_de_travail" value={freelancer.pref_lieu_de_travail} required onChange={(e) => { setFreelancer({ ...freelancer, pref_lieu_de_travail: e.target.value == 'Présence en entreprise' ? 'Présence en entreprise' : e.target.value == 'Travail à distance' ? 'Travail à distance' : 'Peu importe' }) }}>
                            <option>--Choisir une option--</option>
                            <option>Sur place</option>
                            <option>En remote</option>
                ...
                <div className="fourth-div-creation-neoworker">
                    <div className="div-mobilite">
                        ...
                        <select className="input-mobilite" type="text" id="mobilite" name="disponibilite" value={freelancer.mobilite} required onChange={(e) => { setFreelancer({ ...freelancer, mobilite: e.target.value === 'Non' ? 'Non' : 'Oui' }) }}>
                            <option>--Choisir une option--</option>
                            <option>Véhiculé</option>
                            <option>Non véhiculé</option>
                        </select>
                    </div>
                </div>
