...
const HomePageFreelancer = () => {
    ...
    return(
        <div className="freelancer-homepage" style={{textAlign:'center'}}>
            ...
            <img className='pic-card' src='https://media.istockphoto.com/photos/businessman-silhouette-as-avatar-or-default-profile-picture-picture-id476085198?k=6&m=476085198&s=612x612&w=0&h=5cDQxXHFzgyz8qYeBQu2gCZq1_TN0z40e_8ayzne0X0=' alt='profil picture'></img>
            </div>
            <div className="reste-profil">
            <ul>
                <p className='name-card'>Code Postal</p>
                <li>{idFree.cp}</li>
