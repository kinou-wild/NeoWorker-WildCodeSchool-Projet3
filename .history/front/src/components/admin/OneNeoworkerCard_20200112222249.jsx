                    ...
                    <div className='champs-mission'>
                        ...
                        <FormGroup>
                            <Input
                                ...
                                value={neoworker.cp}
                                required
                                onChange={(e) => { setFreelancer({ ...neoworker, cp: e.target.value }) }}
                                maxlength="5" />
                        </FormGroup>
                        <FormGroup>
                            <Input
                        ...
                        <FormGroup>
                            <Input
                                ...
                                value={neoworker.tel}
                                required
                                onChange={(e) => { setFreelancer({ ...neoworker, tel: e.target.value }) }} />
                        </FormGroup>
                        <FormGroup>
                            <Input
                        ...
                        <FormGroup>
                            <Input className="input-tj_min" placeholder='Taux journalier minimum'
                                ...
                                required
                                onChange={(e) => { setFreelancer({ ...neoworker, tjm_min: e.target.value }) }} />
                        </FormGroup>
                        <FormGroup>
                            <Input className="input-tj_max" placeholder='Taux journalier maximum'
                                ...
                                required
                                onChange={(e) => { setFreelancer({ ...neoworker, tjm_max: e.target.value }) }} />
                        </FormGroup>
                        <FormGroup>
                            <Input className="input-dispo" placeholder='Disponibilité(nb jours/mois)'
                                ...
                                required onChange={(e) => { setFreelancer({ ...neoworker, disponibilite: e.target.value }) }} />
                        </FormGroup>
                        <div className='selector-mission'>
                            ...
                            <FormGroup>
                                ...
                                <Input type="select" name="mobilite" id='mobilite'
                                    ...
                                    onChange={(e) => { setFreelancer({ ...neoworker, mobilite: e.target.value === 'Non' ? 'Non' : 'Oui' }) }}>
                                    <option hidden="true">-</option>
                                    <option>Oui</option>
                                    <option>Non</option>
                                </Input>
                            ...
                            <FormGroup>
                                ...
                                <Input type="select" name="km_max" id='km_max'
                                    ...
                                    onChange={(e) => { setFreelancer({ ...neoworker, km_max: e.target.value === '10 km' ? '10 km' : e.target.value === '20 km' ? '20 km' : e.target.value === '30 km' ? '30 km' : e.target.value === '40 km' ? '40 km' : e.target.value === '50 km' ? '50 km' : '10 km' }) }}>
                                    <option hidden="true">-</option>
                                    <option>10 km</option>
                                    <option>20 km</option>
                                    <option>30 km</option>
