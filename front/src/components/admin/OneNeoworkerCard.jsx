                    ...
                    */}
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 1" name="Option 1" value={neoworker.assistance_suivi_comptable} />
                                ...
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 2" name="Option 2" />
                                    <label className="label-prestation" for="Option 2">Relation avec le cabinet d'expertise comptable</label></div>
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 3" name="Option 3" />
                                    <label className="label-prestation" for="Option 3">Relances clients</label></div>
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 4" name="Option 4" />
                                ...
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 5" name="Option 5" />
                                    <label className="label-prestation" for="Option 5">Montage de dossier d'agrément</label></div>
                                <div className="checkbox-and-content">
                                    <input disabled type="checkbox" className="checkbox" id="Option 6" name="Option 6" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 7" name="Option 7" />
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 8" name="Option 8" />
                                    <label className="label-prestation" for="Option 8">Création et mise en place de procédures internes</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 9" name="Option 9" />
                                    <label className="label-prestation" for="Option 9">Création et traitement de base de données</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 10" name="Option 10" />
                                    <label className="label-prestation" for="Option 10">Intendance et gestion des achats</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 11" name="Option 11" />
                                    <label className="label-prestation" for="Option 11">Suivi des dossiers administratifs</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 12" name="Option 12" />
                                    <label className="label-prestation" for="Option 12">Assistanat de direction</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 13" name="Option 13" />
                                    <label className="label-prestationGestion administrative et comptable" for="Option 13">Classement de documents</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 14" name="Option 14" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 15" name="Option 15" />
                                    <label className="label-prestation" for="Option 15">Stratégie et argumentaire commercial</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 16" name="Option 16" />
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 17" name="Option 17" />
                                    <label className="label-prestation" for="Option 17">Prospection / Outbound sales</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 18" name="Option 18" />
                                    <label className="label-prestation" for="Option 18">Intendance et gestion des achats</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 19" name="Option 19" />
                                    <label className="label-prestation" for="Option 19">Réponse aux appels d'offres publics et privés</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 20" name="Option 20" />
                                    <label className="label-prestation" for="Option 20">Administration des ventes</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 21" name="Option 21" />
                                    <label className="label-prestation" for="Option 21">Gestion des stocks</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 22" name="Option 22" />
                                    <label className="label-prestation" for="Option 22">Saisie des données commerciales dans un CRM</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 23" name="Option 23" />
                                    <label className="label-prestation" for="Option 23">Saisie des commandes</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 24" name="Option 24" />
                                    <label className="label-prestation" for="Option 24">Gestion des devis</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 25" name="Option 25" />
                                    <label className="label-prestation" for="Option 25">Facturation</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 26" name="Option 26" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 27" name="Option 27" />
                                    <label className="label-prestation" for="Option 27">Stratégie marketing et suivi opérationnel</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 28" name="Option 28" />
                                    <label className="label-prestation" for="Option 28">Réalisation d'études de marché </label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 29" name="Option 29" />
                                    <label className="label-prestation" for="Option 29">Mise en œuvre d'une stratégie d'inbound marketing</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 30" name="Option 30" />
                                    <label className="label-prestation" for="Option 30">Outbound marketing</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 31" name="Option 31" />
                                    <label className="label-prestation" for="Option 31">Stratégie de communication</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 32" name="Option 32" />
                                    <label className="label-prestation" for="Option 32">Chef de projet externalisé</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 33" name="Option 33" />
                                    <label className="label-prestation" for="Option 33">Création et graphisme</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 34" name="Option 34" />
                                    <label className="label-prestation" for="Option 34">UX Design</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 35" name="Option 35" />
                                    <label className="label-prestation" for="Option 35">UI Design - infographisme</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 36" name="Option 36" />
                                    <label className="label-prestation" for="Option 36">Conception rédaction</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 37" name="Option 37" />
                                    <label className="label-prestation" for="Option 37">Community management</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 38" name="Option 38" />
                                    <label className="label-prestation" for="Option 38">Optimisation SEO</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 39" name="Option 39" />
                                    <label className="label-prestation" for="Option 39">Création de site web</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 40" name="Option 40" />
                                    <label className="label-prestation" for="Option 40">Relation presse</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 41" name="Option 41" />
                                    <label className="label-prestation" for="Option 41">Evènementiel</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 42" name="Option 42" />
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 43" name="Option 43" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 44" name="Option 44" />
                                    <label className="label-prestation" for="Option 44">Direction administrative et financière externalisée</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 45" name="Option 45" />
                                    <label className="label-prestation" for="Option 45">Montage de dossier de financement / subvention</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 46" name="Option 46" />
                                    <label className="label-prestation" for="Option 46">Contrôle de gestion</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 47" name="Option 47" />
                                    <label className="label-prestation" for="Option 47">Tableau de bord et pilotage financier</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 48" name="Option 48" />
                                    <label className="label-prestation" for="Option 48">Création de business plan et budget prévisionnel</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 49" name="Option 49" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 50" name="Option 50" />
                                    <label className="label-prestation" for="Option 50">Direction des Systèmes d'informations externalisée</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 51" name="Option 51" />
                                    <label className="label-prestation" for="Option 51">Schéma directeur SI</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 52" name="Option 52" />
                                    <label className="label-prestation" for="Option 52">Architecture fonctionnelle / applicative</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 53" name="Option 53" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 54" name="Option 54" />
                                    <label className="label-prestation" for="Option 54">Direction des Ressources Humaines externalisée</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 55" name="Option 55" />
                                    <label className="label-prestation" for="Option 55">Gestion des plannings</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 56" name="Option 56" />
                                    <label className="label-prestation" for="Option 56">Suivi des éléments de paie (absences, CP, RTT..)</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 57" name="Option 57" />
                                    <label className="label-prestation" for="Option 57">Etablissement des contrats / éléments de fin de contrats</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 58" name="Option 58" />
                                    <label className="label-prestation" for="Option 58">Suivi mutuelle et medecine du travail</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 59" name="Option 59" />
                                    <label className="label-prestation" for="Option 59">Gestion des conflits</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 60" name="Option 60" />
                                    <label className="label-prestation" for="Option 60">Montage et suivi des dossiers de contentieux</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 61" name="Option 61" />
                                    <label className="label-prestation" for="Option 61">Harmonisation des contrats</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 62" name="Option 62" />
                                    <label className="label-prestation" for="Option 62">Mise en conformité RGPD</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 63" name="Option 63" />
                                    <label className="label-prestation" for="Option 63">Harmonisation des grilles salaires</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 64" name="Option 64" />
                                    <label className="label-prestation" for="Option 64">Gestion prévisionnelle des emplois et des compétences</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 65" name="Option 65" />
                            ...
                            <div className="prestation-checkbox-div">
                                ...
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 66" name="Option 66" />
                                    <label className="label-prestation" for="Option 66">Suivi grands comptes</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 67" name="Option 67" />
                                    <label className="label-prestation" for="Option 67">Ventes additionnelles</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 68" name="Option 68" />
                                    <label className="label-prestation" for="Option 68">Mesure de la satisfaction clients</label></div>
                                <div className="checkbox-and-content"><input disabled type="checkbox" className="checkbox" id="Option 69" name="Option 69" />
