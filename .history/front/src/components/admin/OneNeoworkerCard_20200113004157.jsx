                    ...
                    */}
                        ...
                        <div className="prestation-checkbox-div">
                            ...
                            <div className="checkbox-and-content">
                                <input type="checkbox" className="checkbox" id="Option 1" name="Option 1" defaultChecked={neoworker.assistance_suivi_comptable ? true : false}/>
                        ...
                        <div className="prestation-checkbox-div">
                            ...
                            <div className="checkbox-and-content"><input type="checkbox" className="checkbox" id="Option 38" name="Option 38"   />
                                <label className="label-prestation" for="Option 38">Optimisation SEO</label></div>
                            <div className="checkbox-and-content"><input type="checkbox" className="checkbox" id="Option 39" name="Option 39"   />
