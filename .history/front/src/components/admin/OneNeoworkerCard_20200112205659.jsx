...
const OneNeoworkerCard = ({neoworker, updateNeoworker, update}) => {
                ...
                <Form className="formulaire-creation-neoworker" onSubmit={update} >
                    <FormGroup>
                        <Input style={{ height: '150px' }} placeholder='Notes :' type="textarea" name="note" id="note"
                            ...
                            onChange={(e) => { updateNeoworker({ ...neoworker, note: e.target.value }) }} />
                    </FormGroup>
                    <div className='champs-mission'>
                        <FormGroup>
                            <Input style={{ textAlign: 'center' }}
                                ...
                                required
                                onChange={(e) => { updateNeoworker({ ...neoworker, title: e.target.value }) }} />
                        </FormGroup>
                        <FormGroup>
                            <Input
                                ...
                                required
                                onChange={(e) => { updateNeoworker({ ...neoworker, firstname: e.target.value }) }} />
                        </FormGroup>
                    </div>
                </Form>
            </div>
